...
// Source: github.com/kaviraj-j/go-bank/db/sqlc (interfaces: Store)
...
// GetAccountTransfers mocks base method.
func (m *MockStore) GetAccountTransfers(arg0 context.Context, arg1 db.GetAccountTransfersParams) ([]db.Transfer, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAccountTransfers", arg0, arg1)
	ret0, _ := ret[0].([]db.Transfer)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetAccountTransfers indicates an expected call of GetAccountTransfers.
func (mr *MockStoreMockRecorder) GetAccountTransfers(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAccountTransfers", reflect.TypeOf((*MockStore)(nil).GetAccountTransfers), arg0, arg1)
}
